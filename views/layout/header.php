    ...
    <nav class="navbar navbar-static-top">
      ...
      <div class="collapse navbar-collapse pull-right" id="navbar-collapse">
        <ul class="nav navbar-nav">
            <li id="menu_garson_resturant_ordering"><a href="<?=site_url('order/garson_ordering')?>">سفارش رستورانت<span class="sr-only">(current)</span></a></li>
            ...
            <ul class="dropdown-menu">
              ...
              <li>
                ...
                <?php foreach ($this->order_list as $order): ?>
                  <?php if ($time <= $order->ord_time ): ?>
                  <li>
                    <a href="#">
                      <div class="pull-right">
                        <img src="<?=base_url('assets/img/profiles/'.$order->cus_picture); ?>" class="img-circle" alt="User Image">
                      </div>
                      <h4>
              ...
              <li class="footer"><a href="#">نمایش تمام سفارشات</a></li>
            </ul>
          </li>
          ...
          <li class="dropdown messages-menu ">
            <a href="#" class="dropdown-toggle" data-toggle="dropdown">
              <i class="fa fa-shopping-basket"></i>
                  <?php $time = (new \DateTime())->format('H:i:00'); ?>
              <span class="label label-success"><?= $this->all_order_count ?>
              </span>
            </a>
            <ul class="dropdown-menu">
              <li class="header">  <?= $this->all_order_count ?> سفارش گرفته شده</li>
              <li>
                <!-- inner menu: contains the actual data -->
                <ul class="menu">
                ...
                <?php foreach ($this->all_orders as $order): ?>
                  ...
                  <li>
                    <a href="#">
                      <div class="pull-right">
                        <img src="<?=base_url('assets/img/info/'.$this->session->general_info->ci_logo); ?>" class="img-circle" alt="User Image">
                      </div>
                      <h4>
                        <?php ?>
                        <small><i class="fa fa-calendar"></i>
          ...
          <li class="dropdown user user-menu">
            ...
            <ul class="dropdown-menu">
              ...
              <li class="user-footer">
                <div class="pull-right">
                  <a href="<?=site_url('employee/view/'.$this->session->emp_info->emp_id) ?>" class="btn btn-default btn-flat"><i class="fa fa-user"></i> پروفایل</a>
                </div>
                <div class="pull-left">
