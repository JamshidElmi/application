            ...
            <tbody>
                ...
                <tr id="ord_<?=$order->ord_id ?>">
                    ...
                    <td>
                        ...
                        <a href="<?=site_url('order/print_order_bill/'.$order->ord_id); ?>"><span class="label label-default" data-toggle="tooltip" data-original-title="Print Bill"><i class="fa fa-list-alt fa-lg"></i></span></a>
