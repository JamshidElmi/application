        ...
        <div class="box box-success">
            ...
            <form role="form" method="POST" action="<?=site_url('order/insert_resturant_order/'); ?>">
                ...
                <div class="box-footer">
                    ...
                    <button type="submit" name="submit_print" id="submit_print" disabled class="btn btn-info"><i class="fa fa-save"></i> ذخیره و چاپ <i class="fa fa-print"></i></button>
    ...
    <div id="create_account" class="modal fade" role="dialog">
        <div class="modal-dialog modal-md">
            ...
            <div class="modal-content">
                ...
                <form role="form" method="POST" action="<?=site_url('customer/ordering_insert/create_resturant_order'); ?>" enctype="multipart/form-data" >
                    <div class="modal-body">
