                        ...
                        <div class="col-sm-6">
                            <div class="form-group">
                                ...
                                <div class="input-group date">
                                    ...
                                    <div class="input-group-addon" id="total_price"><?php $ord_discount = 100 - $order->ord_discount; echo $order->ord_price * 100 / $ord_discount; ?></div>
                                </div>
                            </div>
                        </div>
                        <div class="col-sm-6">
                    ...
                    <table class="table table-hover table-bordered table-warning">
                        ...
                        <?php $i=1; foreach ($transections as $transection): ?>
                            <tr id="tr_<?=$transection->tr_id ?>">
                                ...
                                <td class="text-center"><a href="#" class="trans_id_to_delete" id="<?php echo $transection->tr_id; ?>" cus-id="<?php echo $transection->tr_acc_id; ?>"><span class="label label-danger" data-toggle="tooltip" data-original-title="Remove"><i class="fa ion-android-delete fa-lg"></i></span></a></td>
                            </tr>
                        <?php endforeach ?>
                        </tbody>
                    </table>
