...
<div class="row">
    <div class="col-sm-5">
        <div class="box box-success">
            ...
            <!-- /.box-header -->
            <!-- form start -->
            <form role="form" method="POST" action="<?=site_url('order/insert_kitchen_payment/'); ?>">
                    ...
                    <table class="table table-hover table-bordered table-warning">
                        ...
                        <?php $i=1; foreach ($transections as $transection): ?>
                            <tr id="tr_<?=$transection->tr_id ?>">
                                ...
                                <td><?=show_date("j F Y", $transection->tr_date); ?></td>
                                <td><span class="badge bg-gray">پرداخت سفارش</span></td>
                                <td class="text-center"><a href="#" class="trans_id_to_delete read-only" id="<?php echo $transection->tr_id; ?>" cus-id="<?php echo $transection->tr_acc_id; ?>"><span class="label label-danger" data-toggle="tooltip" title="" data-original-title="Remove"><i class="fa ion-android-delete fa-lg"></i></span></a></td>
                            </tr>
                        <?php endforeach ?>
                        </tbody>
                    </table>
