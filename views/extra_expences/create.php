<div class="row">
    <div class="col-lg-5 col-xs-12">
        <div class="box box-success">
            ...
            <!-- /.box-header -->
            <!-- form start -->
            <form action="<?= base_url('finance/insert_extra_expence') ?>" method="POST">
                <div class="box-body">
                    ...
                    <div class="form-group">
                        ...
                        <input type="number" class="form-control" value="0" name="exp_amount" id="amount" placeholder="هزینه را وارد کنید" required>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="input-group date">
                            ...
                            <input type="hidden" id="tarikhAlt" name="exp_date" class="form-control pull-right" style="z-index: 0;">
                        </div><!-- /.input group -->
                    </div>

                    <div class="form-group">
                        <label for="disc">توضیحات / یادداشت</label>
                        <textarea name="exp_disc" class="form-control" rows="7" id="disc" placeholder="توضیحات / یادداشت"></textarea>
                    </div>
