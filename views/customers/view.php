<div class="box box-primary box-solid">
    <div class="box-header with-border">
        <h3 class="box-title">اطلاعات مشتری: <?php echo ($customer->cus_gendar == 0) ? 'خانم' : 'آقای'; ?> <?=$customer->cus_name ." ". $customer->cus_lname ?> کد: <span class="label label-warning "><?=$customer->cus_unique_id ?></span></h3>
        <div class="pull-left box-tools no-print">
            <a target="_BLANK" class="btn btn-info btn-sm" href="<?php echo site_url('customer/print_profile/'.$customer->cus_id); ?>" data-toggle="tooltip" title="" data-original-title="Print"> <i class="fa fa-print fa-lg"></i></a>
        </div>
        <!-- /.box-tools -->
    </div>
    <!-- /.box-header -->
    <div class="box-body">
        <div class="row">
            <div class="col-xs-3">
                <img width="150" src="<?=base_url('assets/img/profiles/'.$customer->cus_picture); ?>" class="img-thumbnail" alt="">
            </div>
            <div class="col-xs-8">
                <table class="table " >
                    <tr><td>&nbsp;</td></tr>
