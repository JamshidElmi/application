...
<!--                                <option value="--><?//= $base_menubm_id ?><!--">--><?//= $base_menubm_name ?><!--</option>-->
<!--                            --><?php //endforeach ?>
<!--                        </select>-->
<!--                    </div>-->
                ...
                <table class="table">
                    ...
                    foreach ($sub_menus as $sub_menu): ?>
                        <tr id="res_<?= $sub_menu->sm_id ?>">
                            ...
                            <td><?= $sub_menu->sm_price; ?> افغانی </td>
                            <td><span data-toggle="tooltip" data-original-title="<?=$sub_menu->sm_desc?>"><?= substr_fa($sub_menu->sm_desc, 40);?></span></td>
                            <td>
