                    ...
                    <?php if ($account->acc_type == 1): ?>
                        ...
                        <div id="radios" class="btn-group" data-toggle="buttons">
                            <label class="btn btn-primary btn-sm active">
                                <input type="radio" name="tr_status" id="tr_status1" value="1" checked /> پرداخت
                            </label>
                        </div>
                    <?php else: ?>
                        <label for="emp_phone">نوعیت عملیات</label> &nbsp;&nbsp;&nbsp;
                        <div id="radios" class="btn-group" data-toggle="buttons">
                            <label class="btn btn-primary btn-sm active">
                                <input type="radio" name="tr_status" id="tr_status1" value="1" checked /> جمع </label>
                            <label class="btn btn-primary btn-sm">
                                <input type="radio" name="tr_status" id="tr_status2" value="2" /> برداشت </label>
                        </div>
                    <?php endif; ?>
            ...
            <div class="box-body">
                ...
                <table class="table table-bordered table-striped">
                    ...
                    <tr>
                        <th>#</th>
                        <th>توضیحات</th>
                        <th><?= ($account->acc_type == 1) ? 'مقدار پرداخت' : 'مقدار جمع / برداشت' ?></th>
                        <th>وضعیت</th>
                    ...
                    foreach ($transections as $transection): ?>
                        <tr id="tr_<?= $transection->tr_id ?>">
                            ...
                            <td class="text-center">
                                <a class="remove read-only" href="<?= site_url('finance/delete_transection/' . $transection->tr_id . '/' . $account->acc_id . '/' . $account->acc_amount); ?>" data-toggle="tooltip" title="" data-original-title="Remove"><span class="label label-danger "><i class="ion ion-trash-b fa-lg"></i></span></a>
                            </td>
                        </tr>
                    ...
                    <?php if ($account->acc_type == 0): ?>
                        <tr>
                            ...
                            <th class="text-center">
                                <i data-toggle="tooltip" title="" data-original-title="Daily Expences" class="ion ion-android-remove-circle fa-lg text-danger"></i>
                            </th>
                            <th class="text-center"> الی امروز</th>
                            <th class="text-center">
                                <span class="label label-default "><i class="ion ion-trash-b fa-lg"></i></span></th>
                        </tr>
                    <?php endif ?>
                    <tr hidden>
                        <th>#</th>
