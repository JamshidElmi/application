                ...
                <table class="table table-bordered table-striped">
                    ...
                    <tbody>
                        ...
                        <tr id="tr_<?=$transection->tr_id  ?>">
                            ...
                            <td class="text-center"><a class="remove read-only" href="<?=site_url('finance/delete_transection/'.$transection->tr_id.'/'.$account->acc_id.'/'.$account->acc_amount); ?>"  data-toggle="tooltip" title="" data-original-title="Remove"><span class="label label-danger "><i class="ion ion-trash-b fa-lg"></i></span></a></td>
                        </tr>
