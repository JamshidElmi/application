...
(2, 'gr6vHb', 'شاه محمود', 'شاه علم', '3453', 'بیکار', 'شرکت خصوصی ساختمانی', 'کابل ', 'غزنی ', 'آدرس دقیق ', '', '', '078595485#02015458455', '1396-08-23', 0, NULL, '', '', '', '', 0, 23);
...
(62, 'افتتاح حساب', '50000.00', 'credit_debit', '1396-08-23', 1, 26, NULL, NULL);
